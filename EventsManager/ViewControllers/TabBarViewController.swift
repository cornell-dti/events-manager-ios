...
class TabBarViewController: UITabBarController, UITabBarControllerDelegate {
    ...
    private func setUpViewControllers() {
        ...
        forYouNavVC = makeNavVC(viewController: ForYouViewController(), title: NSLocalizedString("for-you", comment: ""), tabBarIcon: #imageLiteral(resourceName: "magnifyingGlass"))
